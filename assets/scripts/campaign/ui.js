...
const showCampaignPage = (response) => {
  console.log(response, "this is my show campaign page response i expect, response.campaign")
  store.campaign = response.campaign
...
const showLatestCampaign = (response) => {
  console.log(response, "this is my show latest campaign page response")
  if (response.campaign && store.user) {
    store.campaign = response.campaign
